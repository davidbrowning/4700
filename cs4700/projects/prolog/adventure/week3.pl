...
transfer(small_disk,Pylon):-retract(location(small_disk,_)),assert(location(small_disk,Pylon)).
transfer(medium_disk,Pylon):-not(location(small_disk,Pylon)),location(medium_disk,CurrentLocation),not(location(small_disk,CurrentLocation)),retract(location(medium_disk,_)),assert(location(medium_disk,Pylon)).
transfer(large_disk,Pylon):-not(location(small_disk,Pylon)),not(location(medium_disk,Pylon)),location(large_disk,CurrentLocation),not(location(small_disk,CurrentLocation)),retract(location(large_disk,_)),assert(location(large_disk,Pylon)).
